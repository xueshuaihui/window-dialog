!(function() {
	...
	(function() {
		function t(e) {
			...
			function i(t) {
				('readystatechange' == t.type && 'complete' != s.readyState) ||
					(('load' == t.type ? n : s)[u](d + t.type, i, !1), l || !(l = !0)) ||
					e.call(n, t.type || t);
			}
		...
		for (
			var n = window,
				...
				s = document,
				o = s.documentElement,
				a = s.head || s.getElementsByTagName('head')[0] || o,
				l = '',
				h = s.scripts,
				c = h.length;
			--c >= 0;
		...
		var p = !0,
			...
			g = [];
		for (
			l.replace(/[&?]([^&=]+)=([^&]+)/g, function(e, t, i) {
				(i = decodeURIComponent(i)),
					(t = decodeURIComponent(t)),
					'autorun' == t
						? (p = !/^[0fn]/i.test(i))
						: 'lang' == t ? f.push(i) : 'skin' == t ? m.push(i) : 'callback' == t && g.push(i);
			}),
				c = 0,
				l = f.length;
			l > c;
			...
			(function() {
				...
				(t.onload = t.onerror = t.onreadystatechange = function() {
					!t ||
						...
						((t.onerror = t.onload = t.onreadystatechange = e),
						--y,
						y || r(i, 0),
			...
			return (
				(function() {
					function i(e) {
						function t(e) {
							...
							return (t = u[i])
								...
								: i >= '0' && '7' >= i
									...
									: 'u' === i || 'x' === i ? parseInt(e.substring(2), 16) : e.charCodeAt(1);
						}
						function i(e) {
							return 32 > e
							...
							for (var r = r ? 1 : 0, o = n.length; o > r; ++r) {
								...
								if (/\\[bdsw]/i.test(a)) s.push(a);
									...
									o > r + 2 && '-' === n[r + 1] ? ((l = t(n[r + 2])), (r += 2)) : (l = a),
										...
										65 > l ||
											a > 122 ||
											(65 > l || a > 90 || e.push([ 32 | Math.max(65, a), 32 | Math.min(l, 90) ]),
											97 > l ||
												a > 122 ||
						...
						for (
							var u = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 }, d = [], l = 0, h = e.length;
							h > l;
							++l
						) {
					...
					function c(e, t) {
						for (var i = t.length; --i >= 0; ) {
							var n = t[i];
							O.hasOwnProperty(n)
								? p.console && console.warn('cannot override language handler %s', n)
								: (O[n] = e);
						}
					}
					function u(e, t) {
						return (
							(e && O.hasOwnProperty(e)) || (e = /^\s*</.test(t) ? 'default-markup' : 'default-code'),
							O[e]
						);
					}
					function d(e) {
					...
					c(S, [ 'default-code' ]),
						...
						c(a([], [ [ 'atv', /^[\S\s]+/ ] ]), [ 'uq.val' ]),
						c(l({ keywords: g, hashComments: !0, cStyleComments: !0, types: C }), [
							'c',
							'cc',
							'cpp',
							'cxx',
						...
						c(l({ keywords: 'null,true,false' }), [ 'json' ]),
						c(l({ keywords: v, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: C }), [
							'cs'
						]),
						c(l({ keywords: y, cStyleComments: !0 }), [ 'java' ]),
						c(l({ keywords: f, hashComments: !0, multiLineStrings: !0 }), [ 'bash', 'bsh', 'csh', 'sh' ]),
						c(l({ keywords: b, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }), [
							'cv',
							'py',
							'python'
						]),
						...
						c(l({ keywords: L, hashComments: !0, multiLineStrings: !0, regexLiterals: !0 }), [
							'rb',
							'ruby'
						]),
						c(l({ keywords: m, cStyleComments: !0, regexLiterals: !0 }), [ 'javascript', 'js' ]),
						c(
							l({
								keywords:
						...
						c(l({ keywords: x, cStyleComments: !0, multilineStrings: !0 }), [ 'rc', 'rs', 'rust' ]),
						c(a([], [ [ 'str', /^[\S\s]+/ ] ]), [ 'regex' ]);
					var _ = (p.PR = {
						createSimpleLexer: a,
						...
						prettyPrint: (t = t = function(t, i) {
							function n() {
								for (
									var i = p.PR_SHOULD_USE_CONTINUATION ? m.now() + 250 : 1 / 0;
									l.length > y && i > m.now();
									y++
								) {
									for (var s = l[y], c = S, u = s; (u = u.previousSibling); ) {
										...
										if (O) {
											(c = {}),
												O.replace(/\b(\w+)=([\w%+\-.:]+)/g, function(e, t, i) {
													c[t] = i;
												});
											break;
										}
									...
									if (((u = s.className), (c !== S || b.test(u)) && !L.test(u))) {
										...
										if (!f) {
											if (((s.className += ' prettyprinted'), (f = c.lang), !f)) {
												var _,
													f = u.match(v);
												!f && (_ = o(s)) && C.test(_.tagName) && (f = _.className.match(v)),
													f && (f = f[1]);
											}
											if (x.test(s.tagName)) O = 1;
											else
												var O = s.currentStyle,
													E = a.defaultView,
													O =
														(O = O
															? O.whiteSpace
															: E && E.getComputedStyle
																? E.getComputedStyle(s, e).getPropertyValue('white-space')
																: 0) && 'pre' === O.substring(0, 3);
											(E = c.linenums),
												(E = 'true' === E || +E) ||
													(E = (E = u.match(/\blinenums\b(?::(\d+))?/))
														? E[1] && E[1].length ? +E[1] : !0
														: !1),
												E && h(s, E, O),
												(g = { h: f, c: s, j: E, i: O }),
												d(g);
